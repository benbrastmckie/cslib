...
/-- Axiom schemata for modal logic K5, as the schema-union combinator over `k5Tags` (Phase 8
redefinition, task 523: the inductive is retired; `K5Axiom` is now definitionally
