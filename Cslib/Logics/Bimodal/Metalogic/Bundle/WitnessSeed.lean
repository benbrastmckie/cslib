...
def untilWitnessSeed (M : Set (Formula Atom)) (ψ : Formula Atom) : Set (Formula Atom) :=
  {ψ} ∪ gContent M
...
theorem until_witness_seed_consistent (M : Set (Formula Atom)) (h_mcs : SetMaximalConsistent
  ...
  have h_F_psi : ψ.someFuture ∈ M :=
    SetMaximalConsistent.implication_property h_mcs
      (theoremInMcsFc h_mcs (Theorems.TemporalDerived.untilImpF φ ψ)) h_U
...
theorem since_witness_seed_consistent (M : Set (Formula Atom)) (h_mcs : SetMaximalConsistent
  ...
  have h_P_psi : ψ.somePast ∈ M :=
    SetMaximalConsistent.implication_property h_mcs
      (theoremInMcsFc h_mcs (Theorems.TemporalDerived.sinceImpP φ ψ)) h_S
...
theorem g_content_subset_implies_h_content_reverse
  ...
  have h_H_nn : phi.neg.neg.allPast ∈ M' :=
    SetMaximalConsistent.implication_property h_mcs' (theoremInMcsFc h_mcs' h_H_imp) h_H_phi_in_M'
...
theorem h_content_subset_implies_g_content_reverse
  ...
  have h_G_nn : phi.neg.neg.allFuture ∈ M' :=
    SetMaximalConsistent.implication_property h_mcs' (theoremInMcsFc h_mcs' h_G_imp) h_G_phi
