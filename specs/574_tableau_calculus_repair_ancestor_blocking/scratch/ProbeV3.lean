...
-- V3 = V1 (ancestor-directed, conjunct retained) + self-copy channel removed.
#eval runVariant (some reuseWitnessAncRetained) true 10
#eval runVariant (some reuseWitnessAncRetained) true 20
#eval runVariant (some reuseWitnessAncRetained) true 40
#eval runVariant (some reuseWitnessAncRetained) true 80
#eval runVariant (some reuseWitnessAncRetained) true 120
#eval runVariant (some reuseWitnessAncRetained) true 160
#eval runVariant (some reuseWitnessAncRetained) true 260

end DivergenceProbeV3
