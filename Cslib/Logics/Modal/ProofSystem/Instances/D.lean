...
/-- Axiom schemata for modal logic D, as the schema-union combinator over `dTags` (Phase 8
redefinition, task 523: the inductive is retired; `DAxiom` is now definitionally
