...
> *Note:* A. N. NIThitehead and B. Russell, Principia Mathematica, Vol. 1, 1910; Vol. 2, 1912;
...
> *Note:* H. M. Sheffer, "A Set of Five Independent Postulates for Boolean Algebras, with
...
> *Note:* For a general statement of this viewpoint see C. I. Lewis, Loc. Cit., Chapter VI,
section III.
...
> *Note:* This operation is not explicitly stated in 'Principia' but is pointed out to ber-neces-
...
> *Note:* The method for testing propositions embodied in this theorem is essentially the same
...
> *Note:* But whereas the number of functions of given order is infinite those of given rank
are finite.
...
> *Note:* This argument requires merely the first part of the fundamental theorem which
...
### 5. General Survey of the Systems Generated
The
system we have
...
### 6. Postulates for a Complete System
We
...
> *Note:* That the informal postulates of a system must be proved effectively replaced by
...
### 8. The Generalized Set of Postulates
As in the truth-table develop-
...
### 9. Definition of Consistency and Related Concepts
The
prime requi-
...
### 10. Properties of Consistent Systems.
In
...
> *Note:* Had the name not been in use in a different connection we should have introduced
...
> *Note:* * * q,(p) such that whenever p is replaced by an untrue
...
> *Note:* In making a more complete study of the postulational generalization it would be
...
> *Note:* See Lewis, loc. cit., p. 222 for the term "Two-Valued Algebra."
...
### 13. Truth-Table Characteristics of Asserted Functions
The'following
...
### 14. A Completely Closed Set of Postulates for the Systems
I
and II
...
> *Note:* Or we might take the truth-table as element in which case the system is perhaps
...
> *Note:* Lack of space prevents us from givingf the details.
