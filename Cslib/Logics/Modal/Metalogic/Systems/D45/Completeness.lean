...
private theorem d45_canonical_FC : d45FC (CanonicalModel (@D45Axiom Atom)) := by
  refine ⟨?_, canonical_trans
      (fun φ ψ => D45Axiom.implyK φ ψ) (fun φ ψ χ => D45Axiom.implyS φ ψ χ)
      (fun φ => D45Axiom.modalFour φ),
    canonical_eucl_from_5
      (fun φ ψ => D45Axiom.implyK φ ψ) (fun φ ψ χ => D45Axiom.implyS φ ψ χ)
      (fun φ ψ => D45Axiom.modalK φ ψ) (fun φ => D45Axiom.modalFive φ)⟩
  constructor
  intro S
  exact d_canonical_serial
    (fun φ ψ => D45Axiom.implyK φ ψ) (fun φ ψ χ => D45Axiom.implyS φ ψ χ)
    (fun φ => D45Axiom.efq φ) (fun φ ψ => D45Axiom.modalK φ ψ) (fun φ => D45Axiom.modalD φ) S
