...
theorem rRelation_guard_continues' {A B : Set (Formula Atom)}
  ...
  Cslib.Logic.Metalogic.Chronicle.rRelation_guard_continues'
    temporalChronicleInterface h_r h_until h_not_delta
...
theorem deductiveClosure_closed (Sig : Set (Formula Atom)) :
    ∀ (L : List (Formula Atom)) (φ : Formula Atom),
      (∀ ψ ∈ L, ψ ∈ deductiveClosure Sig) → DerivationTree FrameClass.Base L φ →
        φ ∈ deductiveClosure Sig :=
...
theorem deductiveClosure_closed_under_derivation (Sig : Set (Formula Atom)) :
  ...
  Cslib.Logic.Metalogic.Chronicle.deductiveClosure_closed_under_derivation
    temporalChronicleInterface Sig
...
theorem rMaximal_extension_exists {A : Set (Formula Atom)}
  ...
  Cslib.Logic.Metalogic.Chronicle.rMaximal_extension_exists
    temporalChronicleInterface h_mcs h_dcs h_r
...
theorem r3Maximal_extension_exists {A C : Set (Formula Atom)}
  ...
  Cslib.Logic.Metalogic.Chronicle.r3Maximal_extension_exists
    temporalChronicleInterface h_mcs_A h_mcs_C h_dcs h_r3
...
theorem burgessR_absorption {A D C : Set (Formula Atom)}
    ...
    burgessR A β C :=
  Cslib.Logic.Metalogic.Chronicle.burgessR_absorption
    temporalChronicleInterface h_mcs_A h_mcs_D β h_β_D h_rAD h_rDC
...
theorem burgessRSince_absorption {A D C : Set (Formula Atom)}
    ...
    burgessRSince A β C :=
  Cslib.Logic.Metalogic.Chronicle.burgessRSince_absorption
    temporalChronicleInterface h_mcs_A h_mcs_D β h_β_D h_rAD h_rDC
...
theorem burgessRSet_absorption {A D C : Set (Formula Atom)} {B : Set (Formula Atom)}
    ...
    burgessRSet A B C :=
  Cslib.Logic.Metalogic.Chronicle.burgessRSet_absorption
    temporalChronicleInterface h_mcs_A h_mcs_D h_sub_D h_rAD h_rDC
...
theorem burgessRSetSince_absorption {A D C : Set (Formula Atom)} {B : Set (Formula Atom)}
  ...
  Cslib.Logic.Metalogic.Chronicle.burgessRSetSince_absorption
    temporalChronicleInterface h_mcs_A h_mcs_D h_sub_D h_rAD h_rDC
...
theorem burgessR3_absorption {A D C : Set (Formula Atom)} {B : Set (Formula Atom)}
    ...
    burgessR3 A B C :=
  Cslib.Logic.Metalogic.Chronicle.burgessR3_absorption
    temporalChronicleInterface h_mcs_A h_mcs_D h_mcs_C h_sub_D h_r3_AD h_r3_DC
...
theorem mcs_contrapositive_mem {M : Set (Formula Atom)}
    ...
    (¬φ) ∈ M :=
  Cslib.Logic.Metalogic.Chronicle.mcs_contrapositive_mem
    temporalChronicleInterface h_mcs h_imp h_neg_psi
...
theorem deductiveClosure_singleton_imp {B : Set (Formula Atom)}
    ...
    φ ∈ B :=
  Cslib.Logic.Metalogic.Chronicle.deductiveClosure_singleton_imp
    temporalChronicleInterface h_cud h_delta h_imp
...
theorem dcs_neg_insert_consistent {B : Set (Formula Atom)}
  ...
  Cslib.Logic.Metalogic.Chronicle.dcs_neg_insert_consistent
    temporalChronicleInterface h_cud h_not_mem
...
theorem burgessR3Maximal_extension_exists {A C : Set (Formula Atom)}
  ...
  Cslib.Logic.Metalogic.Chronicle.burgessR3Maximal_extension_exists
    temporalChronicleInterface h_mcs_A h_mcs_C h_cud h_br3
...
theorem neg_allFuture_neg_to_someFuture {M : Set (Formula Atom)}
    ...
    (𝐅γ) ∈ M :=
  Cslib.Logic.Metalogic.Chronicle.neg_allFuture_neg_to_someFuture
    temporalChronicleInterface h_mcs γ h
...
theorem someFuture_H_neg_G_P_absurd {M : Set (Formula Atom)}
  ...
  Cslib.Logic.Metalogic.Chronicle.someFuture_H_neg_G_P_absurd
    temporalChronicleInterface h_mcs α h_F h_GP
...
theorem somePast_G_neg_H_F_absurd {M : Set (Formula Atom)}
  ...
  Cslib.Logic.Metalogic.Chronicle.somePast_G_neg_H_F_absurd
    temporalChronicleInterface h_mcs γ h_P h_HF
...
theorem burgessR_implies_burgessRSince {A C : Set (Formula Atom)}
    ...
    burgessRSince C β A :=
  Cslib.Logic.Metalogic.Chronicle.burgessR_implies_burgessRSince
    temporalChronicleInterface h_mcs_A h_mcs_C h_burgessR

theorem burgessRSince_implies_burgessR {A C : Set (Formula Atom)}
    (h_mcs_A : Temporal.SetMaximalConsistent A) (h_mcs_C : Temporal.SetMaximalConsistent C)
    {β : Formula Atom} (h_burgessRSince : burgessRSince C β A) :
    burgessR A β C :=
  Cslib.Logic.Metalogic.Chronicle.burgessRSince_implies_burgessR
    temporalChronicleInterface h_mcs_A h_mcs_C h_burgessRSince
...
theorem burgessR_of_deductiveClosure_singleton {A C : Set (Formula Atom)} {η : Formula Atom}
  ...
  Cslib.Logic.Metalogic.Chronicle.burgessR_of_deductiveClosure_singleton
    temporalChronicleInterface h_mcs_A h_burgessR φ hφ
...
theorem burgessRSince_of_deductiveClosure_singleton {A C : Set (Formula Atom)} {η : Formula Atom}
  ...
  Cslib.Logic.Metalogic.Chronicle.burgessRSince_of_deductiveClosure_singleton
    temporalChronicleInterface h_mcs_C h_burgessRSince φ hφ
...
theorem burgessR3Maximal_exists_from_seed (A C : Set (Formula Atom)) (η : Formula Atom)
  ...
  Cslib.Logic.Metalogic.Chronicle.burgessR3Maximal_exists_from_seed
    temporalChronicleInterface A C η h_mcs_A h_mcs_C h_burgessR h_burgessRSince h_η_A
