...
theorem k_truth_lemma
  ...
  | .imp φ ψ => by
    ...
    · intro h_mem h_sat_phi
      exact (k_truth_lemma h_implyK h_implyS h_efq h_peirce h_K
  ...
  | .or φ ψ => by
    ...
    · intro h_sat
      ...
      cases h_sat with
      | inl h1 => exact Or.inl ((k_truth_lemma h_implyK h_implyS h_efq h_peirce h_K
          h_andI h_andE1 h_andE2 h_orI1 h_orI2 h_orE h_dualFwd h_dualBack S φ).mp h1)
      | inr h2 => exact Or.inr ((k_truth_lemma h_implyK h_implyS h_efq h_peirce h_K
    ...
    · intro h_mem
      rcases (mcs_or_mem_iff h_implyK h_implyS h_orI1 h_orI2 h_orE S.property).mp h_mem
        with h1 | h2
      · exact Or.inl ((k_truth_lemma h_implyK h_implyS h_efq h_peirce h_K
          h_andI h_andE1 h_andE2 h_orI1 h_orI2 h_orE h_dualFwd h_dualBack S φ).mpr h1)
      · exact Or.inr ((k_truth_lemma h_implyK h_implyS h_efq h_peirce h_K
          h_andI h_andE1 h_andE2 h_orI1 h_orI2 h_orE h_dualFwd h_dualBack S ψ).mpr h2)
  | .box φ => by
    constructor
    · intro h_sat
